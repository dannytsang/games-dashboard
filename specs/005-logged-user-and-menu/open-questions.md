...
4. Should the chip show the avatar image instead of an emoji? (Current
   decision: emoji for MVP; avatar is a future enhancement.)
5. Should the menu support keyboard shortcuts (e.g. `Alt+T` for theme,
